...
class ENT_Specialist extends StatefulWidget {
  @override
  _ENT_SpecialistState createState() => _ENT_SpecialistState();
}

class _ENT_SpecialistState extends State<ENT_Specialist> {
  @override
          ...
          children: [
            Expanded(
                child: StreamBuilder<QuerySnapshot>(
                    stream:FirebaseFirestore.instance.collection('Doctors').where('Speciality',isEqualTo: 'ENT Specialist').snapshots(),
