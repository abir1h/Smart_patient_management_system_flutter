...
import 'package:smart_patientmanagement_system/Doctor_tabbar_pages/open_image.dart';
import 'package:smart_patientmanagement_system/Patient_Ui/Homepage.dart';
import 'package:smart_patientmanagement_system/Patient_Ui/openImage_patient.dart';
class prescriptions extends StatefulWidget {
  DocumentSnapshot info;

  prescriptions({this.info});
  @override
...
class _prescriptionsState extends State<prescriptions> {
  ...
  Widget build(BuildContext context) {
    ...
    String phone=widget.info.data()['Mobile'];
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        backgroundColor: Colors.white,
        title: Text("Prescriptons",
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: firestore
            ...
            .where('Patient_phone', isEqualTo: phone)
            .snapshots(),
...
Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
  Navigatedata(String info){
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (_)=>opens_image_patients(url: info,)));
  }
