...
class prescriptions_tab extends StatefulWidget {
  DocumentSnapshot info;

  prescriptions_tab({this.info});
  @override
  _prescriptions_tabState createState() => _prescriptions_tabState();
}

class _prescriptions_tabState extends State<prescriptions_tab> {
...
Widget _buildListItem(BuildContext context, DocumentSnapshot data) {
  Navigatedata(String info){
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (_)=>opens_image(url: info,)));
  }
